...
namespace SCILL
{
    ...
    public class SCILLClient
    {
        ...
        private void StartMonitorUserChallenges()
        {
            ...
            //     var notificationTopic =  AuthApi.GetUserChallengesNotificationTopicAsync();
            //
            //     // Subscribe to a topic
            //      _challengesMqttClient.SubscribeAsync(new MqttTopicFilterBuilder()
            ...
            //     .Build();
            //
            //  _challengesMqttClient.ConnectAsync(options, CancellationToken.None);
        }
        ...
        private void StopMonitorUserChallenges()
        {
            ...
            // }
            //
            //  _challengesMqttClient.DisconnectAsync();
